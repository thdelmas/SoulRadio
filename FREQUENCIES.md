...
| 23:00–06:00   | 7.83 Hz  | Held by the Earth's hum        |
...
- **Use:** Below the threshold of human hearing (~20 Hz). In our night band (23:00–06:00) it appears as a *pulse* — a soft amplitude modulation under whatever else is playing — not as an audible tone. The body senses it as cadence, not sound.
